...
This chapter describes the eight Social Security benefit taxation reform options analyzed in this study. Each option represents a different approach to modifying the current two-tier taxation system, with varying implications for revenue generation, taxpayer burden, and trust fund solvency.
...
**Economic Incidence:** This reform represents a fundamental shift in the tax base. By exempting benefits and taxing contributions, the tax burden is effectively shifted from current benefit recipients (retirees) to current contributors (workers). This creates an intergenerational transfer, increasing the after-tax income of current retirees while reducing the after-tax income of the working-age population.
