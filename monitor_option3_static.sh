...
# Monitor Option 3 Static jobs
JOB1="years-20251124-074842-ju2p43"  # 2026-2027
JOB2="years-20251124-074845-pflh3b"  # 2028-2100

echo "=== Monitoring Option 3 Static Jobs ==="
echo ""

while true; do
  clear
  echo "=== Option 3 Static - Job Status ==="
  ...
  if [[ "$status1" == "SUCCEEDED" && "$status2" == "SUCCEEDED" ]]; then
    ...
    echo "  gsutil -m cp gs://crfb-ss-analysis-results/results/$JOB1/*.csv results/option3_static_temp/"
    echo "  gsutil -m cp gs://crfb-ss-analysis-results/results/$JOB2/*.csv results/option3_static_temp/"
    break
