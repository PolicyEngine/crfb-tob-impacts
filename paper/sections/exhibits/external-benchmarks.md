...
| --- | --- | --- | --- | --- |
| PolicyEngine | option1 full repeal | Static | 2026-2035 | -1,974.2 |
...
| Source | Policy | Scoring | Window | Revenue Impact ($B) |
| --- | --- | --- | --- | --- |
| PolicyEngine | option2 tax 85% uniformly | Static | 2026-2035 | +357.1 |
| PolicyEngine | option8 tax 100% of benefits | Static | 2026-2035 | +880.0 |
...
| Source | Policy | Scoring | Window | Revenue Impact ($B) |
| --- | --- | --- | --- | --- |
| PolicyEngine | option7 eliminate bonus senior deduction | Static | 2026-2035 | +75.0 |
